...
{
	var jabea = f.jabea.value; //EZ DA FORMULARIOTIK JASO BEHAR -> SESSION KONTROLA
	var izena = f.izena.value; 
	var data = date("Y-m-d h:i:sa"); //EZ DA FORMULARIOTIK JASO BEHAR
	var trailer = f.trailer_url.value; // EZ DA DERRIGORREZKOA
	var esteka = f.esteka.value;
	var argazki = f.argazki_url.value; // EZ DA DERRIGORREZKOA
	...
	else if(trailer.lastIndexOf(".") + 2 > trailer.length - 1){
