	...
	<body>
		...
		<?php
			...
			<?php
				...
				<tr><td></td>
				<td><input type="button" class="hasi1" value="LOGIN" onclick="location.href='login0.php'"><input type="button" class="hasi1" value="REGISTER" onclick="location.href='register.php'"></td>
